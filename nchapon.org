...
*** Hydra GTD Workflow -> C-c C-g
My Org / Gtd workflow hydra should be always accessible in all mode with =C-c C-g=
#+BEGIN_SRC emacs-lisp
  ...
  ")
      ...
      ("g p" (find-file-other-window nc/org-default-projects-file) "projects")
      ...
      (define-key global-map  (kbd "C-c C-g") 'nc-hydra-org/body)
#+END_SRC
*** Hydra org-table
