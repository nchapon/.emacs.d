...
**** helm-swoop
 ...
 #+begin_src emacs-lisp
   (use-package helm-swoop
     :ensure t
     :bind (("C-c o s o" . helm-multi-swoop-org)
...
Insert daily header in journal file =C-c-o-i=
   ...
   #+BEGIN_SRC emacs-lisp
     (defun nc--autoinsert-yas-expand ()
         ...
         (custom-set-variables
          '(auto-insert 'other)
          '(auto-insert-directory "~/_PIM/notes/templates"))
   ...
   (setq org-capture-templates
           '(("t" "Task Entry"        entry
             ...
             ("f" "FishLog" plain (file+datetree+prompt nc/fishing-file)
              "%[~/_PIM/notes/templates/fishlog.org]")
...
*** Bookmark entry
 ...
 Bookmark entry are captured in journal Bookmark heading.
 ...
 #+BEGIN_SRC emacs-lisp
   (defun org-journal-find-bookmark ()
     ...
     (goto-char (point-min))
     (search-forward (concat "Bookmarks " (format-time-string "%Y-W%W"))))

   (add-to-list 'org-capture-templates
                  `("b" "Bookmark" entry (function org-journal-find-bookmark)
...
#+BEGIN_SRC emacs-lisp
  (add-to-list 'org-capture-templates
               ...
               (file "~/_PIM/notes/templates/newproject.org")))
#+END_SRC
 ...
 #+BEGIN_SRC emacs-lisp
   ...
   (add-to-list 'org-capture-templates
                  `("d" "Review: Daily Review" entry (function org-journal-find-location)
                    (file "~/_PIM/notes/templates/dailyreview.org")
                    :clock-in t :clock-resume t))
 #+END_SRC
...
*** WeeklyReview
 ...
 (add-to-list 'org-capture-templates
            ...
            "* Summary of the week :REVIEW:\n%[~/_PIM/notes/templates/review.org]"))
 #+END_SRC
** Agenda
...
#+begin_src emacs-lisp
  (setq org-agenda-file-regexp "\\`[^.].*\\.org\\'\\|[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]$"
          org-agenda-files (list "~/_PIM/notes/gtd.org" "~/_PIM/notes/projects.org" "~/_PIM/notes/someday.org" "~/_PIM/notes/personal/calendar.org" "~/_PIM/notes/journal/")
          org-agenda-span 'day
...
*** Diary
 #+BEGIN_SRC emacs-lisp
   (setq diary-file "~/_PIM/notes/diary"
...
*** Speed commands
 ...
 #+BEGIN_SRC emacs-lisp
   ...
   (bind-key "C-c o s" 'nc/org-go-speed)
 #+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package deft
      ...
      (("<f8>" . deft))
      :config
      (setq deft-directory "~/_PIM/notes"
            deft-recursive t
            deft-extensions '("org")
...
#+BEGIN_SRC emacs-lisp
  (use-package yankpad
    :ensure t
    :init
    (setq yankpad-file "~/_PIM/notes/templates/yankpad.org")
    :config
