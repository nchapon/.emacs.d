...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-c o") 'nc/find-current-month-notes-file)
...
#+begin_src emacs-lisp
  (setq org-capture-templates
        '(("t" "todo" entry (file+headline (concat org-directory "GTD/inbox.org") "Tasks" )
           "* TODO %?\n%U\n%a\n" :clock-in t :clock-resume t)
          ("n" "Next Task" entry (file+headline (concat org-directory "GTD/inbox.org") "Tasks")
           "** NEXT %?")
      ...
      %U" :prepend t)
          ...
          ("p" "Phone call" entry (file+datetree (file+datetree org-default-notes-file))
                 "* PHONE %? :PHONE:\n%U" :clock-in t :clock-resume t)
          ("a" "RendezVous" entry (file+datetree+prompt (nc--expand-org-notes-path "GTD/diary.org"))
                 "* RDV %? :APPT:\n%U\nSCHEDULED: %(org-insert-time-stamp (org-read-date nil t \"+0d\"))\n")
