...
**** helm-semantic and imenu
 ...
 #+begin_src emacs-lisp
   ...
   (global-set-key (kbd "M-1") 'nc/helm-in-buffer)
 #+end_src
**** Restore arrows keys
...
*** Hydra GTD Workflow -> C-c g
My Org / Gtd workflow hydra should be always accessible in all mode with =C-c g=
#+BEGIN_SRC emacs-lisp
  ...
  ")
      ...
      (define-key global-map  (kbd "C-c g") 'nc-hydra-org/body)
#+END_SRC
*** Hydra org-table
