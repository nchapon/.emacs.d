...
#+BEGIN_SRC emacs-lisp
    ...
    (when (eq window-system 'x)
      (add-hook 'after-init-hook #'nc/setup-x11-fonts))
...
*** Visual commands
Commands lisetd below are run in a term buffer
#+begin_src emacs-lisp
...
*** Call =ls= after cd command
#+begin_src emacs-lisp
(setq eshell-list-files-after-cd t)
#+end_src
*** Aliases
#+begin_src emacs-lisp
(setq eshell-aliases-file (concat no-littering-etc-directory ".eshell-aliases"))
#+end_src
*** Clear terminal
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-<f1>") 'nc/eshell-here)
#+end_src

My function x exits that shell and closes that windows
