...
*** Files and directories
 ...
 #+begin_src emacs-lisp
   ...
   (defconst nc/org-default-projects-file (concat org-directory "projects/projects.org"))
...
(setq nc--f-key-settings (concat
  ...
  (propertize
  "  F1      S-F1           F3   F4  ┃  F5      F6     F7       F8    ┃  F9                  F10      F11     F12
  " 'face '(:foreground "green"))
  "^^^^^^Hydra   Hydra Global            ┃  Revert  Magit  Yankpad  Deft  ┃  Interruption task   Menu     Clock   Agenda"))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ---- Global Helper ----
    ...
    ("I" nc/inbox-file "inbox tasks file")
...
*** Hydra org
 #+BEGIN_SRC emacs-lisp
   (defhydra hydra-org
     ...
     ("I" nc/inbox-file "inbox tasks file" :color blue :column "Org Files")
     ("j" nc/journal-file-today "journal file today")
     ("y" nc/journal-file-yesterday "yesterday file")
     ("p" nc/go-to-projects "projects")
    ...
    ("X" (lambda ()
     ...
     ("d" nc/journal-file-insert nil)
     ("D" nc/daily-review nil)
     ("iD" nc/insert-datestamp "datestamp")
     ("id" nc/insert-datestamp-inactive "date stamp inactive")
...
#+BEGIN_SRC emacs-lisp
(defhydra hydra-org-table (:color pink :hint nil :columns 3)
    "
  org table helper
  _R_ insert row
  ...
  "
    ...
    ("R" org-table-insert-row :color blue)
...
#+END_SRC
*** Hydra org-babel
#+BEGIN_SRC emacs-lisp :dir blah :results output
