...
*** Emacs Config File
 ...
 #+begin_src emacs-lisp
   (defun nc/emacs-config ()
       "Edit nchapon.org"
       (interactive)
       (find-file "~/.emacs.d/nchapon.org"))

     (global-set-key (kbd "C-c f e") 'nc/emacs-config)
 #+end_src
...
*** Files and directories
 ...
 #+begin_src emacs-lisp
   ...
   (defconst nc/org-default-tasks-file (concat org-directory "gtd/tasks.org"))
   ...
   (defconst nc/org-default-someday-file (concat org-directory "gtd/someday.org"))
...
My global hydra almost used in all modes
#+BEGIN_SRC emacs-lisp
  ...
  ")
      ...
      ("<up>" org-previous-visible-heading "↑ previous" :column "Navigate")
      ("<down>" org-next-visible-heading "↓ next")
      ("d" org-cut-subtree "delete")

      ("g t" (find-file-other-window nc/org-default-tasks-file) "tasks"  :column "Go To")
      ("g i" nc/go-to-inbox "inbox")
      ("g j" nc/journal-file-today "journal file today")
      ("g y" nc/journal-file-yesterday "yesterday file")
      ("g c" (lambda ()
             (interactive)
             (super-save-mode nil)
      ...
      ;; Insert
      ("i p" nc/generate-password "password"  :column "Inserting")
      ("i d" nc/journal-file-insert "daily template")
      ("i D" nc/daily-review "daily review")

      ("i s" nc/insert-time-slot "time slot" :column "Inserting Date/Time")
      ("i T" nc/insert-datestamp "datestamp")
      ("i t" nc/insert-datestamp-inactive "date stamp inactive")
