...
**** Agenda configuration
 ...
 #+BEGIN_SRC emacs-lisp
   (setq org-agenda-files (list "~/notes/personal/calendar.org" "~/notes/journal/" "~/notes/projects/")
         org-agenda-span 'day
                      ...
                      ((agenda "" ((org-agenda-sorting-strategy '(timestamp-up time-up priority-down category-keep))))
                       ...
                       (tags-todo "TODO=\"TODO\"-HOLD"
                                  ((org-agenda-overriding-header "Other tasks")
                                   ...
                                   (org-agenda-files '("~/notes/projects/tasks.org"))
                                   (org-agenda-sorting-strategy '(priority-down todo-state-up category-keep))))
                       )
                      nil)
               ("g" . "GTD contexts")
                  ("go" "Office" tags-todo "@office")
                  ("ge" "Computer" tags-todo "@computer")
                  ("gp" "Emacs" tags-todo "emacs")
