...
#+BEGIN_SRC emacs-lisp
  (setq org-agenda-files (list "~/notes/dates" "~/notes/projects" "~/notes/agenda.org")
        org-agenda-span 2
  ...
  (setq org-capture-templates
        '(("t" "todo" entry (file+headline org-default-notes-file "Tasks" )
          ...
          ("n" "Next Task" entry (file+headline (nc--expand-org-notes-path "GTD/refile.org") "Tasks")
           "** NEXT %?")
          ("s" "Someday / Maybe" entry (file+headline (nc--expand-org-notes-path "GTD/todo.org") "Someday / Maybe")
            "* SOMEDAY %? :IDEA:\n%u" :clock-in t :clock-resume t)
          ("f" "FishLog" plain (file+datetree+prompt (concat org-directory "topics/sports/fishing.org"))
      ...
      %U" :prepend t)
          ...
          ("i" "Interrupting task" entry
             ...
             "* %^{Task}"
             :clock-in t :clock-resume t)
          ("m" "Meeting" entry (file+headline (concat org-directory "agenda.org") "Réunions")
          ...
          ("w" "WeeklyReview" entry (file+datetree+prompt org-default-notes-file)
           ...
           ("D" "Done Business Task" entry
             (file+headline (nc--expand-org-notes-path "GTD/office.org") "Done Tasks")
             "* DONE %^{Task}"
             :clock-in t :clock-resume t)
          ))
#+end_src
