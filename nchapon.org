...
#+BEGIN_SRC emacs-lisp
  (let* ((variable-tuple (cond ((x-list-fonts "Input Sans") '(:font "Input Sans"))
         ...
         (headline           `(:inherit default :weight light :foreground ,base-font-color)))
    ...
    (custom-theme-set-faces 'user
                            ...
                            `(org-checkbox ((t (:foreground "#69ffeb"
                                           :box (:line-width 1 :style released-button)))))
                            `(org-date ((t (:foreground "#69ffeb"))))
                            `(org-tag ((t (:foreground "#e6b68d"))))

                            `(org-checkbox-statistics-todo ((t (:foreground "#69ffeb"))))
                            '(org-list-dt               ((t (:foreground "#69ffeb"))))
...
(setq nc--f-key-settings (concat
  ...
  (propertize
  "F1      S-F1           | F5      F6     F7       | F8    F9                  F10      F11     F12
"
