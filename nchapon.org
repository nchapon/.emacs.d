...
*** Files and directories
 ...
 #+begin_src emacs-lisp
   ...
   (defconst nc/org-default-projects-file (concat org-directory "gtd/tasks.org"))
...
#+begin_src emacs-lisp
  (use-package org-agenda
    ...
    (setq org-agenda-file-regexp "\\`[^.].*\\.org\\'\\|[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]$"
          org-agenda-files (list "~/notes/gtd/" "~/notes/personal/calendar.org" "~/notes/journal/")
          org-agenda-span 'day
...
** Searching in my notes -> C-c o s
 #+begin_src emacs-lisp
   ...
   (bind-key "C-c o s" 'nc/helm-do-grep-notes)
 #+end_src
** Babel
*** Babel languages
...
#+END_SRC
** org-roam
Org Roam dierctory is tested only in my =~/notes/resources= directory
#+BEGIN_SRC emacs-lisp
  (use-package org-roam
        :hook
        (after-init . org-roam-mode)
        :custom
        (org-roam-directory nc/org-default-resources-dir)
...
#+END_SRC
** Hydra -> <C-c h>
My Hydras are bound by default to =C-c h=
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "C-c h") 'nc/context-hydra-launcher)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  'face '(:foreground "teal"))
    "Help    Treemacs  | Revert  Magit  Yankpad  | Deft  Interruption task   Menu     Clock   Agenda
  "
    "---------------------------------------------------------------------------------------------------------------"))
#+END_SRC

*** Hydra Org -> C-c C-h
My Org / Gtd workflow hydra should be always accessible in all mode with =C-c C-h=
#+BEGIN_SRC emacs-lisp
  ...
  ")
      ...
      (define-key global-map  (kbd "C-c C-h") 'nc-hydra-org/body)
#+END_SRC
*** Hydra org-table
