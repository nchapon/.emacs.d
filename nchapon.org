...
(setq nc--f-key-settings (concat
  ...
  "    Hydra   Hydra Global    ★       ┃  revert-buffer  Magit  Yankpad  Deft  ┃  Interruption task     Menu     Clock   Agenda
...
#+BEGIN_SRC emacs-lisp
  (defhydra hydra-global (:color blue)
    (concat nc--f-key-settings
            "
      ^^Go To Files                    ^^Go To Dirs                        ^^Actions
      ^────────^───────────────────────^──────^─────────────────────────^─────────^───────────────
      _e_macs init file               _P_rojects Dir                   _d_elete file
      _j_ournal file today             _R_esources Dir                  _r_ename file
      _p_ersonal credentials           _S_ources Dir                    _s_ilver searcher
      _y_esterday file                 _X_ PIM
      ^^                               ^^                               ^^
      ^^                               ^^                               ^^

      ")

    ("e" nc/find-config nil)
    ("j" nc/journal-file-today nil)
    ("y" nc/journal-file-yesterday nil)
    ...
    ("d" nc/delete-this-file nil)
    ("r" nc/rename-this-file-and-buffer nil)
    ("s" helm-do-ag nil)
...
*** Hydra org
 #+BEGIN_SRC emacs-lisp
   (defhydra hydra-org (:color blue)
     ...
     ^────────^───────────────────────^──────^─────────────────────────^─────────^───────────────
     _p_rojects                       _t_ime slot                      _g_enerate password
     _R_esources directory            _d_aily plan                     ^^
     _P_ersonal directory             _D_aily review                   ^^
     ^^                               ^^                               ^^
     ^^Filter                         ^^Export                         ^^MISC
     ^────────^───────────────────────^──────^─────────────────────────^─────────^───────────────
     ^^                               ^^                               ^^
     _2_ org-tags-view  (C-c a m)     ^^                               ^^
     ^^                               ^^                               ^^
     _f_ocus agenda (prio A; sched .) ^^                               ^^
     ...
     ("p" nc/go-to-projects nil)
     ("R" nc/go-to-resources-dir nil)
     ...
     ("g" nc/generate-password nil)
     ("q" nil "quit")
     ("<f1>" hydra-global/body "Global")
