...
** Registers
Registers can be used to navigate to specific files, used by key chord =JJ=
#+begin_src emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  (use-package org-journal
         :ensure t
          :init
          (setq org-journal-dir "~/notes/GTD/journal/")
          (setq org-journal-date-format "#+TITLE: %e %b %Y (%A)")
...
#+BEGIN_SRC emacs-lisp
  (setq org-agenda-files (list "~/notes/GTD/" "~/notes/GTD/journal/")
        org-agenda-span 'day
...
**** Agenda Commands
    ...
    #+BEGIN_SRC emacs-lisp
      ...
      (require 'org-agenda)
      (setq nc/org-agenda-inbox-view
            `("i" "Inbox" todo ""
              ((org-agenda-files '("~/notes/GTD/inbox.org")))))


      (setq nc/org-agenda-todo-view
            `(" " "Agenda"
      ...
      (setq nc/org-agenda-context-view
            `("@" "Contexts"
              ((todo "STARTED"
      ...
      (setq org-agenda-custom-commands
            `(,nc/org-agenda-inbox-view
              ,nc/org-agenda-todo-view
              ,nc/org-agenda-context-view))
...
#+begin_src emacs-lisp
  ...
  (defconst nc/fishing-file (concat org-directory "topics/sports/fishing.org"))
  (defconst nc/diary-file (concat org-directory "GTD/diary-log.org"))
  (defconst nc/someday-file (concat org-directory "GTD/someday.org"))
...
#+begin_src emacs-lisp
  (setq org-capture-templates
        '(("t" "todo" entry (file+headline nc/inbox-file "Inbox" )
           "* TODO %?\n%U\n%a\n" :clock-in t :clock-resume t)
          ("n" "Next Task" entry (file+headline nc/inbox-file "Inbox")
           "** NEXT %?")
      ...
      %U" :prepend t)
          ...
          ("w" "WeeklyReview" entry (file+datetree+prompt nc/weekly-review-file)
           ...
           ("D" "Done Business Task" entry
             (file+headline nc/inbox-file "Done Tasks")
             "* DONE %^{Task}"
             :clock-in t :clock-resume t)
          ))
#+end_src
...
** Weekly Review
*** Reset checkboxes
Reset checkbox items when weekly review is done
#+BEGIN_SRC emacs-lisp
(defun nc/clean-weekly-review ()
    "Clean week"
  (interactive)
  (org-with-point-at
    (org-id-find "id-weekly-review" 'marker)
