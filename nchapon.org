...
#+BEGIN_SRC emacs-lisp
  (defhydra hydra-global (:color blue)
    (concat nc--f-key-settings
      ...
      ^^Go To                          ^^Actions                        ^^Other
      ^────────^───────────────────────^──────^─────────────────────────^─────────^───────────────
      _j_ournal file today             _d_elete file                    _i_nit file
      _y_esterday file                 _r_ename file                    _p_ersonal credentials
      _P_roject dir                    _S_ilver Searcher                ^^
      ^^                               ^^                               ^^

      ")

    ("i" nc/find-config nil)
