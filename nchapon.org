...
#+begin_src emacs-lisp
  (setq org-capture-templates
        '(("t" "todo" entry (file+headline (concat org-directory "GTD/inbox.org") "Inbox" )
          ...
          ("n" "Next Task" entry (file+headline (concat org-directory "GTD/inbox.org") "Inbox")
           "** NEXT %?")
          ("s" "Someday / Maybe" entry (file+headline (concat org-directory "GTD/inbox.org") "Someday / Maybe")
      ...
      %U" :prepend t)
          ...
          ("i" "Interrupting task" entry
             ...
             "* %^{Task}"
             :clock-in t :clock-resume t)
          ("m" "Meeting" entry (file+headline (concat org-directory "GTD/mygtd.org") "Réunions")
           "* MEETING %? :MEETING:\n%U\nSCHEDULED: %(org-insert-time-stamp (org-read-date nil t \"+0d\"))\n")
          ("p" "Phone call" entry (file+datetree (concat org-directory "GTD/diary-log.org"))
                 "* PHONE %? :PHONE:\n%U" :clock-in t :clock-resume t)
          ("a" "RendezVous" entry (file+headline (concat org-directory "GTD/mygtd.org") "RendezVous")
                 "* RDV %? :APPT:\n%U\nSCHEDULED: %(org-insert-time-stamp (org-read-date nil t \"+0d\"))\n")
