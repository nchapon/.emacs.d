...
*** Files and directories
 ...
 #+begin_src emacs-lisp
   ...
   (defconst nc/org-default-projects-file (concat org-directory "gtd/inbox.org"))
...
#+BEGIN_SRC emacs-lisp
  (add-to-list 'org-capture-templates
                     `("p" "New Project" entry (file+headline nc/org-default-projects-file "Inbox")
